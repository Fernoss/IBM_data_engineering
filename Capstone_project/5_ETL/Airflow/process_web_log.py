...
# define the first task - extract data
...
# define the second task - transform data in the txt file
transform_data = BashOperator(
    task_id='transform_data',
    # grepping "198.46.149.143"
...
# define the third - load data
load_data = BashOperator(
    task_id='load_data',
    # archive transformed_data.txt 
